...
$arrBox[0]=array( 'p1'=>'lorem',
                 'p2'=>'Lorem uisquam nihil',
                 'p3'=> 'neque fugt? Non a comquam error voluptatibus quae!'
                 );
// box2
$arrBox[1]=array( 'p1'=>'INNOVATION',
                  'p2'=>"현실이 되는 곳",
                  'p3' =>'다양한 기업이 꿈을 키워 나가는 곳 혁신의 시작을 함께하는 곳, 63입니다.',
                 );
// box3
$arrBox[2]=array('p1'=>'ABOUT 63',
                  'p2'=>"반사되는 금빛 파사드",
                  'p3' =>'1985년 완공 이후 서울을 대표하는 상징적인 건축물로 햇빛에 따라 반사되는 금빛 외관이 인상적입니다',
                 );
// box4
$arrBox[3]=array(
                 'p1'=>'FESTIVAL',
